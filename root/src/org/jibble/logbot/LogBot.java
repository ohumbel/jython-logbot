...
public class LogBot extends PircBot {
    ...
    public void append(String color, String line, Writer writer, Date now) throws IOException {
        ...
        String entry = "<span class=\"irc-date\">[" + time + "]</span> <span class=\"" + color
                + "\">" + line + "</span><br />";
    ...
    @Override
    public void onPing(String sourceNick,
                       String sourceLogin,
                       String sourceHostname,
                       String target,
                       String pingValue) {
    ...
    public void onQuit(String sourceNick, String sourceLogin, String sourceHostname, String reason) {
        String line = "* " + sourceNick + " (" + sourceLogin + "@" + sourceHostname + ") Quit ("
                + reason + ")";
        append(NAVY, line);
    }
    ...
    @Override
    public void onVersion(String sourceNick,
                          String sourceLogin,
                          String sourceHostname,
                          String target) {
